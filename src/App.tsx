	...
	return (
		<div className="w-full bg-[#d2dae1]">
			...
			<div className="h-screen flex flex-col items-center justify-center gap-0">
				...
				<motion.div
					className="z-10 sticky top-[30%] lg:top-[25%]"
					initial={{ x: -300 }}
					animate={{ x: 0 }}
					transition={{ duration: 0.7 }}
				>
				...
				<motion.div 
					className="w-full p-1 flex items-center justify-evenly"
					initial={{y: 200}}
					animate={{y: 0}}
					transition={{duration: 0.7}}
				>
					<KeyNumber title="386 kW/525 ch" subtitle="Puissance (kW)/Puissance (ch)"/>
					<KeyNumber title="3,2 s" subtitle="Accélération de 0 à 100 km/h"/>
					<KeyNumber title="296 km/h" subtitle="Vitesse maximale sur circuit"/>
				</motion.div>
			</div>
			<div>
